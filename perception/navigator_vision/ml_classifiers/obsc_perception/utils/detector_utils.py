...
TRAINED_MODEL_DIR = rospack.get_path(
    'navigator_vision') + '/ml_classifiers/obsc_perception'
...
PATH_TO_CKPT = TRAINED_MODEL_DIR + \
    '/dock_inference/inference_graph/frozen_inference_graph.pb'
# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = TRAINED_MODEL_DIR + '/dock_inference/totems&buoys.pbtxt'
