...
class IdentifyDockMission:
    ...
    def get_waypoint(self):
        ...
        #  self.dock_pose = np.array([88.6192321777,-515.189880
        #self.dock_pose = np.array([175.425643921,-691.467041016,0.366470336914])
    ...
    def circle_dock_bays(self):
        ...
        def circle_bay():
          ...
          yield self.navigator.move.circle_point(self.dock_pose, direction=self.CIRCLE_DIRECTION).go()
          done_circle = True
