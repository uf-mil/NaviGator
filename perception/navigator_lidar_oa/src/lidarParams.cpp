...
std::vector<std::string> ROIS = {"BuoyField","CoralSurvey","FindBreak","AcousticPinger","Shooter","Scan_The_Code","Gate_1","Gate_2","Gate_3","Dock"};
...
double VOXEL_SIZE_Z_MIN_HITS = 5;