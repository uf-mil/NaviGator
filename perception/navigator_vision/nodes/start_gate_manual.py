...
def do_buoys(srv, left, right, red_seg, green_seg, tf_listener):
    ...
    for i in range(5):
        ...
        mil_tools.draw_ray_3d(red_left_pt, left_cam, [1, 0, 0, 1],  m_id=0, frame="stereo_left_cam")
        mil_tools.draw_ray_3d(red_right_pt, right_cam, [1, 0, 0, 1],  m_id=1, frame="stereo_right_cam")
        mil_tools.draw_ray_3d(green_left_pt, left_cam, [0, 1, 0, 1],  m_id=2, frame="stereo_left_cam")
        mil_tools.draw_ray_3d(green_right_pt, right_cam, [0, 1, 0, 1],  m_id=3, frame="stereo_right_cam")
